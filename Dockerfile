...
ENV PHASE2E_STALL_SECONDS=600
ENV STAGE1_BARRIER_POLL_SECONDS=30
ENV STAGE1_BARRIER_TIMEOUT=7200
ENV PHASE2E_MISS_THRESHOLD=40
ENV PHASE2E_CF_BACKOFF_MAX=120
